...
function MultilayeredFractal:ApplyTectonics(args)
	...
	local hillsBottom1 = 26 - adjustment;
	local hillsTop1 = 26 + adjustment;
	local hillsBottom2 = 60 - adjustment;
	local hillsTop2 = 60 + adjustment;
	local hillsClumps = 0 + adjustment;
	local hillsNearMountains = 91 - (adjustment * 2) - extra_mountains;
	local mountains = 44 - adjustment - extra_mountains;
